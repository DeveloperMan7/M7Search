...
@interface M7SearchSuggestionViewController ()
...
@implementation M7SearchSuggestionViewController
...
- (void)setSearchSuggestions:(NSArray<NSString *> *)searchSuggestions
{
     ...
     * more information can see : https://github.com/iphone5solo/M7Search/issues/61
     */
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *cellID = @"M7SearchSuggestionCellID";
